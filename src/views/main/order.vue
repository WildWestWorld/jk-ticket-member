...
export default defineComponent({
  ...
  setup() {
    ...
    const handleOk = () => {
      ...
      axios
        .post("/business/confirmOrder/doConfirm", {
        ...
        .then((response) => {
          ...
          if (data.success) {
            ...
            confirmOrderId.value = data.result;
    ...
    const queryLineCount = () => {
      ...
      queryLineCountInterval = setInterval(function () {
        axios
          .get("/business/confirmOrder/queryLineCount/" + confirmOrderId.value)
          .then((response) => {
            let data = response.data;
            if (data.success) {
    ...
    const onCancelOrder = () => {
      axios
        .get("/business/confirmOrder/cancel/" + confirmOrderId.value)
        .then((response) => {
          let data = response.data;
          if (data.success) {
